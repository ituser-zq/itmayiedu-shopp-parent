 ...
 * @ClassName:WecharController
 * @Description:  三方SDKAPI使用
 * @Author: ZQ
 * @Date:2019/05/03 15:53
 */
@Controller
...
public class WecharController {
    ...
    public String authorize(@RequestParam("returnUrl") String returnUrl) {
        ...
        String redirectUrl = wxOpenService.oauth2buildAuthorizationUrl(url, WxConsts.OAUTH2_SCOPE_BASE, URLEncoder.encode(returnUrl));
